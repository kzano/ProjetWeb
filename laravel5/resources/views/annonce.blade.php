...
<body>
    ...
    <div class="container-fluid align-middle">
        <div id="carouselAnnonce" class="carousel slide carousel-lenght mx-auto" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="http://127.0.0.1/laravel5/public/publications/{{$annonce->Image_1}}" class="d-block w-100 rounded-top img-fluid"
                        alt="...">
                </div>
                <div class="carousel-item">
                    <img src="http://127.0.0.1/laravel5/public/publications/{{$annonce->Image_2}}" class="d-block w-100 rounded-top img-fluid"
                        alt="...">
                </div>
                <div class="carousel-item">
                    <img src="http://127.0.0.1/laravel5/public/publications/{{$annonce->Image_3}}" class="d-block w-100 rounded-top img-fluid"
                        alt="...">
                </div>
            </div>
        ...
        <div class="mx-auto p-3 shadow bg-white rounded-bottom" style="width: 60%;">
            <!-- titre de l'annonce -->
            <div>
                <div class="mb-2">
                    <h1>{{$annonce->Titre}}</h1>
                    <span class="span-prix">{{$annonce->Prix}}</span>
                </div>
            </div>
            ...
            <div>
                ...
                <p>Mail : {{$user->Mail}}, Telephone : {{$user->Tel}}</p>
            </div>
        </div>
    </div>
